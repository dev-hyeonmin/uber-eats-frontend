...
export const EditProfile = () => {
    ...
    const [editProfile, {data: editProfileResult, loading}] = useMutation<editProfile, editProfileVariables>(EDIT_PROFILE_MUTATION, {
        onCompleted
    });
    ...
    return (
        <div className="mt-52 flex flex-col justify-center items-center">
            <Helmet>
                <title>Edit Account | Nuber Eats</title>
            </Helmet>
